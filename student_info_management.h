...
public:
    ...
    void set_is_sorted_(int is_sorted) { this->is_sorted_ = is_sorted; };
...
private:
    ...
    vector<Student> tmp_vector_; //StudentList의 학생 정보 벡터를 받아 온다. 
    ...
    string input_tel_;
public:
    Insertion(StudentList student_list); // 생성자                 
    void Input(); //정보 입력 받기
    ...
    vector<Student> get_tmp_vector_() { return tmp_vector_; }
};
...
public:
    ...
    vector<Student> get_searching_tmp_vector_() { return this->tmp_vector_; }//tmp_vector_ 접근자
